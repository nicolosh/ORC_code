# TASK space control: is OPerational Space or Cartesian Control: E.E position
import numpy as np
...
PLOT_EE_POS = 1
PLOT_EE_VEL = 0 # useless
PLOT_EE_ACC = 0
PLOT_JOINT_VEL = 1
PLOT_TORQUES = 1

tsid = TsidManipulator(conf) # create the Q.P problem
...
# these 2 methods to create a sphere which represents the target position for the E.E in the 
# viewer and the real position to check how it's the tracking
...
# -----------------STARTING SIMULATION----------
# NOW THE sinusoidal rEFERENCE Is computed for the E.E instead of the joints(Ex_0)
for i in range(0, N):
