...
# NOW WE HAVE TORQUE LIMITS (IN EX_0 no!): IT IS A MORE COMPLETE VERSION OF THE
# VERY SAME PROBLEM
class TsidManipulator:
    ...
    def __init__(self, conf, viewer=True):
        ...
        # TaskSE3Equality allows to control the POSE: SE3 is a special euclidean space for the body POSE or group of dimension 3
        ...
        actuationBoundsTask = tsid.TaskActuationBounds("task-actuation-bounds", robot) # torque bounds
